"""CPU/small-env smoke only. This module cannot create a PPO runner or checkpoint."""
...
def run(num_envs: int = 2, steps: int = 3, seed: int = 123) -> dict:
...
def main() -> None:
    ...
    print(json.dumps(run(args.num_envs, args.steps, args.seed), indent=2))
